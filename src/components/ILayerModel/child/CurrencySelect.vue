<template lang="pug">
  .container.box.box-row
    .num-con.box.box-y-center
      i.iconfont &#xe606;
      input(class="box-col-flex" type="text" v-model="searchText" :placeholder="$t('fund.choose')+'OTC'")
...
export default {
  ...
  computed: {
    selectedList() {
      if (this.searchText) return this.currencyList.filter(item => item.searchText.indexOf(this.searchText) !== -1)
