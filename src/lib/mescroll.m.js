...
MeScroll.prototype.extendDownScroll = function (a) {
  MeScroll.extend(a, {
    ...
    showLoading: function (b) {
      if (b.downTipDom) {
        b.downTipDom.innerHTML = i18n.t('home.loading')
      }
      if (b.downProgressDom) {
        b
          .downProgressDom
...
MeScroll.prototype.extendUpScroll = function (a) {
  ...
  MeScroll.extend(a, {
    ...
    htmlLoading: '<p class="upwarp-progress mescroll-rotate"></p><p class="upwarp-tip">'+i18n.t('home.loading')+'</p>',
...
MeScroll.prototype.initDownScroll = function () {
  ...
  b.touchstartEvent = function (c) {
    ...
    if (b.os.pc && b.getScrollTop() <= 0) {
      b
        .scrollDom
        .addEventListener("mousemove", b.touchmoveEvent);
  ...
  b
    .scrollDom
    .addEventListener("mousedown", b.touchstartEvent);
  b
    .scrollDom
    .addEventListener("touchstart", b.touchstartEvent);
          ...
          if (b.downHight < b.optDown.offset) {
            if (b.movetype != 1) {
              ...
              b
                .downwarp
                .classList
                .remove(b.optDown.resetClass);
              b
                .scrollDom
                .classList
                .add(b.optDown.hardwareClass);
  ...
  b
    .scrollDom
    .addEventListener("touchmove", b.touchmoveEvent);
  b.touchendEvent = function () {
    if (b.optDown.use && b.isMoveDown) {
      ...
      b
        .scrollDom
        .classList
        .remove(b.optDown.hardwareClass);
      b.movetype = 0;
      b.isMoveDown = false
    }
    if (b.os.pc) {
      b
        .scrollDom
        .removeEventListener("mousemove", b.touchmoveEvent);
      document.ondragstart = function () {
        return true
      }
    }
  ...
  b
    .scrollDom
    .addEventListener("mouseup", b.touchendEvent);
  b
    .scrollDom
    .addEventListener("mouseleave", b.touchendEvent);
  b
    .scrollDom
    .addEventListener("touchend", b.touchendEvent);
  b
    .scrollDom
    .addEventListener("touchcancel", b.touchendEvent);
  if (b.optDown.use) {
    ...
    var a = b.optDown.warpId
      ? b.getDomById(b.optDown.warpId)
      : b.scrollDom;
...
MeScroll.prototype.initUpScroll = function () {
  ...
  if (b.optUp.scrollbar.use) {
    b
      .scrollDom
      .classList
      .add(b.optUp.scrollbar.barClass)
  }
  if (!b.optUp.isBounce) {
    b.setBounce(false)
  }
  ...
  if (b.isScrollBody) {
    ...
    b
      .scrollDom
      .addEventListener("scroll", b.scrollEvent)
  }
  setTimeout(function () {
    b
      .optUp
...
MeScroll.prototype.showUpScroll = function () {
  ...
  this
    .upwarp
    .classList
    .add(this.optUp.hardwareClass);
  this.upwarp.style.visibility = "visible";
  this
    .optUp
    .showLoading(this, this.upwarp)
};
...
MeScroll.prototype.hideUpScroll = function () {
  ...
  this
    .upwarp
    .classList
    .remove(this.optUp.hardwareClass);
  var a = this
    .upwarp
    .getElementsByClassName("upwarp-progress")[0];
  if (a) {
    a
      .classList
      .remove("mescroll-rotate")
...
MeScroll.prototype.showEmpty = function () {
  ...
  if (f) {
    ...
    if (c.btnClick) {
      var d = b
        .emptyDom
        .getElementsByClassName("empty-btn")[0];
      if (c.supportTap) {
        d
          .addEventListener("tap", function (g) {
            g.stopPropagation();
            g.preventDefault();
            c.btnClick()
          })
  ...
  if (!this.topBtnShow) {
    ...
    if (b.toTopBtn == null) {
      ...
      if (c.supportTap) {
        b
          .toTopBtn
          .addEventListener("tap", function (d) {
            d.stopPropagation();
            d.preventDefault();
...
MeScroll.prototype.hideTopBtn = function () {
  if (this.topBtnShow && this.toTopBtn) {
    ...
    this
      .toTopBtn
      .classList
      .remove(this.optUp.toTop.showClass);
    this
      .toTopBtn
      .classList
      .add(this.optUp.toTop.hideClass)
  }
};
...
MeScroll.prototype.destroy = function () {
  ...
  a
    .scrollDom
    .removeEventListener("touchstart", a.touchstartEvent);
  a
    .scrollDom
    .removeEventListener("touchmove", a.touchmoveEvent);
  a
    .scrollDom
    .removeEventListener("touchend", a.touchendEvent);
  a
    .scrollDom
    .removeEventListener("touchcancel", a.touchendEvent);
  a
    .scrollDom
    .removeEventListener("mousedown", a.touchstartEvent);
  a
    .scrollDom
    .removeEventListener("mousemove", a.touchmoveEvent);
  a
    .scrollDom
    .removeEventListener("mouseup", a.touchendEvent);
  a
    .scrollDom
    .removeEventListener("mouseleave", a.touchendEvent);
  ...
  if (a.isScrollBody) {
    ...
    a
      .scrollDom
      .removeEventListener("scroll", a.scrollEvent)
  }
